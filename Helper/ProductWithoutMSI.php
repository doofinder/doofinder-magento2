 ...
 */
class ProductWithoutMSI extends AbstractHelper
{
    /**
    ...
    public function getQuantityAndStockStatus(ProductModel $product, ?int $stockId = null): string
    {
        ...
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('*******************');
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('*******************');
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('******************* getQuantityAndStockStatus without MSI');
    ...
    public function getProductAvailability(\Magento\Catalog\Model\Product $product)
    {
        ...
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('*******************');
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('*******************');
        \Magento\Framework\App\ObjectManager::getInstance()->get(\Psr\Log\LoggerInterface::class)->debug('******************* getProductAvailability without MSI');
